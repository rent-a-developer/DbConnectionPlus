...
.DESCRIPTION
    MSBuild keeps stale assemblies, generated files and NuGet asset lists in bin/ and obj/. Benchmark and
    documentation tooling also creates repository-level artifact folders. When a project is renamed, a package
...
$knownGeneratedDirectories = @(
    ...
    # publish, the generated API metadata, the documentation site and the extracted release notes.
    'artifacts'
