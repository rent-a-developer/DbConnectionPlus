...
public static partial class DbConnectionExtensions
{
    ...
    /// <returns>
    /// A <see cref="DataRow" /> containing the data of the first row of the result set returned by the statement or
    ...
    /// using static RentADeveloper.DbConnectionPlus.DbConnectionExtensions;
    ///
    /// dynamic? product = connection.QueryFirstOrDefault($"SELECT * FROM Product WHERE Id = {Parameter(id)}");
    ///
    /// if (product is not null)
    /// {
    ///     var id = product.Id;
    ...
    /// </code>
    /// </example>
    public static DataRow? QueryFirstOrDefault(
    ...
    /// <see cref="Task{TResult}.Result" /> will contain a <see cref="DataRow" /> containing the data of the first row
    ...
    /// using static RentADeveloper.DbConnectionPlus.DbConnectionExtensions;
    ///
    /// dynamic? product = await connection.QueryFirstOrDefaultAsync($"SELECT * FROM Product WHERE Id = {Parameter(id)}");
    ///
    /// if (product is not null)
    /// {
    ///     var id = product.Id;
    ...
    /// </code>
    /// </example>
    public static async Task<DataRow?> QueryFirstOrDefaultAsync(
        this DbConnection connection,
        InterpolatedSqlStatement statement,
        DbTransaction? transaction = null,
        TimeSpan? commandTimeout = null,
