...
public static partial class DbConnectionExtensions
{
    ...
    /// as the column or <see langword="null" /> if the statement did not return any rows.
    /// </summary>
    ...
    /// <returns>
    /// A dynamic object containing the data of the single row of the result set returned by the statement or
    ...
    /// with the same name as the column or <see langword="null" /> if the statement did not return any rows.
    /// </summary>
    /// <param name="connection">The database connection to use to execute the statement.</param>
    /// <param name="statement">The SQL statement to execute.</param>
    /// <param name="transaction">The database transaction within to execute the statement.</param>
    ...
    /// result set returned by the statement or <see langword="null" /> if the statement did not return any rows.
    /// </returns>
    /// <exception cref="ArgumentNullException"><paramref name="connection" /> is <see langword="null" />.</exception>
    /// <exception cref="InvalidOperationException">The SQL statement did return more than one row.</exception>
    /// <exception cref="OperationCanceledException">
