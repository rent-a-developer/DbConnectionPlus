...
public sealed class DbCommandDisposerTests_MySql : DbCommandDisposerTests<MySqlTestDatabaseProvider>;

public sealed class DbCommandDisposerTests_Oracle : DbCommandDisposerTests<OracleTestDatabaseProvider>;

public sealed class DbCommandDisposerTests_PostgreSql : DbCommandDisposerTests<PostgreSqlTestDatabaseProvider>;

public sealed class DbCommandDisposerTests_Sqlite : DbCommandDisposerTests<SqliteTestDatabaseProvider>;

public sealed class DbCommandDisposerTests_SqlServer : DbCommandDisposerTests<SqlServerTestDatabaseProvider>;
    ...
    where TTestDatabaseProvider : ITestDatabaseProvider, new()
{
    ...
    public async Task DisposeAsync_AlreadyDisposed_ShouldNotAttemptToDropTemporaryTablesAgain()
    {
        ...
        await Invoking(() => commandDisposer.DisposeAsync().AsTask()).Should().NotThrowAsync();
