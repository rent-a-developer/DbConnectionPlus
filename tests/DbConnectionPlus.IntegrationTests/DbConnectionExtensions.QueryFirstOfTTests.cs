...
public sealed class DbConnectionExtensions_QueryFirstOfTTests_MySql
...
public sealed class DbConnectionExtensions_QueryFirstOfTTests_PostgreSql
    : DbConnectionExtensions_QueryFirstOfTTests<PostgreSqlTestDatabaseProvider>;

public sealed class DbConnectionExtensions_QueryFirstOfTTests_Sqlite
...
public abstract class DbConnectionExtensions_QueryFirstOfTTests<TTestDatabaseProvider>
    ...
    where TTestDatabaseProvider : ITestDatabaseProvider, new()
{
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_BuiltInType_CharTargetType_ColumnContainsStringWithLengthOne_ShouldGetFirstCharacter(
        bool useAsyncApi
    )
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public Task QueryFirst_BuiltInType_ColumnValueCannotBeConvertedToTargetType_ShouldThrow(bool useAsyncApi) =>
        Invoking(() =>
                CallApi<int>(
                    useAsyncApi,
                    this.Connection,
    ...
    [InlineData(false)]
    [InlineData(true)]
    public Task QueryFirst_BuiltInType_EnumTargetType_ColumnContainsInvalidInteger_ShouldThrow(bool useAsyncApi) =>
        Invoking(() =>
                CallApi<TestEnum>(
                    useAsyncApi,
                    this.Connection,
    ...
    [InlineData(false)]
    [InlineData(true)]
    public Task QueryFirst_BuiltInType_EnumTargetType_ColumnContainsInvalidString_ShouldThrow(bool useAsyncApi) =>
        Invoking(() =>
                CallApi<TestEnum>(
                    useAsyncApi,
                    this.Connection,
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_BuiltInType_EnumTargetType_ShouldConvertIntegerToEnum(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_BuiltInType_EnumTargetType_ShouldConvertStringToEnum(bool useAsyncApi)
    {
        var enumValue = Generate.Single<TestEnum>();
    ...
    [InlineData(false)]
    [InlineData(true)]
    public Task QueryFirst_BuiltInType_NonNullableTargetType_ColumnContainsNull_ShouldThrow(bool useAsyncApi) =>
        Invoking(() =>
                CallApi<int>(
                    useAsyncApi,
                    this.Connection,
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_BuiltInType_NullableTargetType_ColumnContainsNull_ShouldReturnNull(bool useAsyncApi) =>
        (
            await CallApi<int?>(
                useAsyncApi,
                this.Connection,
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_BuiltInType_ShouldSupportDateTimeOffsetValues(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_ComplexObjectsTemporaryTable_ShouldDropTemporaryTableAfterExecution(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_ComplexObjectsTemporaryTable_ShouldPassInterpolatedObjectsAsMultiColumnTemporaryTable(
        bool useAsyncApi
    )
    {
        Assert.SkipUnless(this.DatabaseAdapter.SupportsTemporaryTables(this.Connection), "");
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_EntityType_CharEntityProperty_ColumnContainsStringWithLengthNotOne_ShouldThrow(
        bool useAsyncApi
    )
    {
        if (this.TestDatabaseProvider is not OracleTestDatabaseProvider)
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_EntityType_CharEntityProperty_ColumnContainsStringWithLengthOne_ShouldGetFirstCharacter(
        bool useAsyncApi
    )
    {
        var character = Generate.Single<char>();
    ...
    [InlineData(false)]
    [InlineData(true)]
    public Task QueryFirst_EntityType_ColumnDataTypeNotCompatibleWithEntityPropertyType_ShouldThrow(bool useAsyncApi) =>
        Invoking(() =>
                CallApi<Entity>(
                    useAsyncApi,
                    this.Connection,
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_EntityType_ColumnHasNoName_ShouldThrow(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_EntityType_CompatiblePrivateConstructor_ShouldUsePrivateConstructor(bool useAsyncApi)
    {
        var entities = this.CreateEntitiesInDb<Entity>(2);
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_EntityType_CompatiblePublicConstructor_ShouldUsePublicConstructor(bool useAsyncApi)
    {
        var entities = this.CreateEntitiesInDb<Entity>(2);
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_EntityType_EnumEntityProperty_ShouldConvertIntegerToEnum(bool useAsyncApi)
    {
        var enumValue = Generate.Single<TestEnum>();
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_EntityType_EnumEntityProperty_ShouldConvertStringToEnum(bool useAsyncApi)
    {
        var enumValue = Generate.Single<TestEnum>();
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_EntityType_Mapping_Attributes_ShouldUseAttributesMapping(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_EntityType_Mapping_FluentApi_ShouldUseFluentApiMapping(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_EntityType_NoCompatibleConstructor_PrivateParameterlessConstructor_ShouldUsePrivateConstructorAndProperties(
        bool useAsyncApi
    )
    {
        var entities = this.CreateEntitiesInDb<Entity>(2);
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_EntityType_NoCompatibleConstructor_PublicParameterlessConstructor_ShouldUsePublicConstructorAndProperties(
        bool useAsyncApi
    )
    {
        var entities = this.CreateEntitiesInDb<Entity>(2);
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_EntityType_NoMapping_ShouldUseEntityTypeNameAndPropertyNames(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public Task QueryFirst_EntityType_NonNullableEntityProperty_ColumnContainsNull_ShouldThrow(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_EntityType_NullableEntityProperty_ColumnContainsNull_ShouldReturnNull(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_EntityType_ShouldSupportDateTimeOffsetValues(bool useAsyncApi)
    {
        Assert.SkipUnless(this.TestDatabaseProvider.SupportsDateTimeOffset, "");
    ...
    [InlineData(false)]
    [InlineData(true)]
    public Task QueryFirst_EntityType_UnsupportedFieldType_ShouldThrow(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_ScalarValuesTemporaryTable_ShouldPassInterpolatedValuesAsSingleColumnTemporaryTable(
        bool useAsyncApi
    )
    {
        Assert.SkipUnless(this.DatabaseAdapter.SupportsTemporaryTables(this.Connection), "");
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_ValueTupleType_CharValueTupleField_ColumnContainsStringWithLengthNotOne_ShouldThrow(
        bool useAsyncApi
    )
    {
        if (this.TestDatabaseProvider is not OracleTestDatabaseProvider)
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_ValueTupleType_CharValueTupleField_ColumnContainsStringWithLengthOne_ShouldGetFirstCharacter(
        bool useAsyncApi
    )
    {
        var character = Generate.Single<char>();
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_ValueTupleType_EnumValueTupleField_ShouldConvertIntegerToEnum(bool useAsyncApi)
    {
        var enumValue = Generate.Single<TestEnum>();
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_ValueTupleType_EnumValueTupleField_ShouldConvertStringToEnum(bool useAsyncApi)
    {
        var enumValue = Generate.Single<TestEnum>();
    ...
    [InlineData(false)]
    [InlineData(true)]
    public Task QueryFirst_ValueTupleType_NonNullableValueTupleField_ColumnContainsNull_ShouldThrow(bool useAsyncApi)
    {
        this.Connection.ExecuteNonQuery($"INSERT INTO {Q("Entity")} ({Q("Id")}, {Q("BooleanValue")}) VALUES(1, NULL)");
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_ValueTupleType_ShouldMaterializeBinaryData(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_ValueTupleType_ShouldSupportDateTimeOffsetValues(bool useAsyncApi)
    {
        Assert.SkipUnless(this.TestDatabaseProvider.SupportsDateTimeOffset, "");
    ...
    [InlineData(false)]
    [InlineData(true)]
    public Task QueryFirst_ValueTupleType_UnsupportedFieldType_ShouldThrow(bool useAsyncApi)
    {
        Assert.SkipUnless(this.TestDatabaseProvider.HasUnsupportedDataType, "");
    ...
    )
    {
        ...
        try
        {
            return Task.FromResult(
                connection.QueryFirst<T>(statement, transaction, commandTimeout, commandType, cancellationToken)
            );
        }
        catch (Exception ex)
        {
