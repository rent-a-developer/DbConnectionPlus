    ...
    where TTestDatabaseProvider : ITestDatabaseProvider, new()
{
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_EntityType_ShouldMaterializeBinaryData(Boolean useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirst_EntityType_ShouldUseConfiguredColumnNames(Boolean useAsyncApi)
    {
