    ...
    where TTestDatabaseProvider : ITestDatabaseProvider, new()
{
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirstOrDefault_BuiltInType_EnumTargetType_ShouldConvertIntegerToEnum(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirstOrDefault_BuiltInType_EnumTargetType_ShouldConvertStringToEnum(bool useAsyncApi)
    {
        var enumValue = Generate.Single<TestEnum>();
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirstOrDefault_BuiltInType_ShouldSupportDateTimeOffsetValues(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirstOrDefault_CommandType_ShouldUseCommandType(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirstOrDefault_EntityType_ColumnHasNoName_ShouldThrow(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirstOrDefault_EntityType_EnumEntityProperty_ShouldConvertIntegerToEnum(bool useAsyncApi)
    {
        var enumValue = Generate.Single<TestEnum>();
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirstOrDefault_EntityType_EnumEntityProperty_ShouldConvertStringToEnum(bool useAsyncApi)
    {
        var enumValue = Generate.Single<TestEnum>();
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirstOrDefault_EntityType_Mapping_Attributes_ShouldUseAttributesMapping(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirstOrDefault_EntityType_Mapping_FluentApi_ShouldUseFluentApiMapping(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirstOrDefault_EntityType_ShouldSupportDateTimeOffsetValues(bool useAsyncApi)
    {
        Assert.SkipUnless(this.TestDatabaseProvider.SupportsDateTimeOffset, "");
    ...
    [InlineData(false)]
    [InlineData(true)]
    public Task QueryFirstOrDefault_EntityType_UnsupportedFieldType_ShouldThrow(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirstOrDefault_InterpolatedParameter_ShouldPassInterpolatedParameter(bool useAsyncApi)
    {
        var entities = this.CreateEntitiesInDb<Entity>(2);
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirstOrDefault_Parameter_ShouldPassParameter(bool useAsyncApi)
    {
        var entities = this.CreateEntitiesInDb<Entity>(2);
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirstOrDefault_Transaction_ShouldUseTransaction(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirstOrDefault_ValueTupleType_ShouldMaterializeBinaryData(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QueryFirstOrDefault_ValueTupleType_ShouldSupportDateTimeOffsetValues(bool useAsyncApi)
    {
        Assert.SkipUnless(this.TestDatabaseProvider.SupportsDateTimeOffset, "");
    ...
    [InlineData(false)]
    [InlineData(true)]
    public Task QueryFirstOrDefault_ValueTupleType_UnsupportedFieldType_ShouldThrow(bool useAsyncApi)
    {
        Assert.SkipUnless(this.TestDatabaseProvider.HasUnsupportedDataType, "");
