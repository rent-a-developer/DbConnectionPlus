...
public sealed class DbConnectionExtensions_QuerySingleOrDefaultOfTTests_MySql
    : DbConnectionExtensions_QuerySingleOrDefaultOfTTests<MySqlTestDatabaseProvider>;

public sealed class DbConnectionExtensions_QuerySingleOrDefaultOfTTests_Oracle
    : DbConnectionExtensions_QuerySingleOrDefaultOfTTests<OracleTestDatabaseProvider>;

public sealed class DbConnectionExtensions_QuerySingleOrDefaultOfTTests_PostgreSql
...
public sealed class DbConnectionExtensions_QuerySingleOrDefaultOfTTests_SqlServer
    : DbConnectionExtensions_QuerySingleOrDefaultOfTTests<SqlServerTestDatabaseProvider>;

public abstract class DbConnectionExtensions_QuerySingleOrDefaultOfTTests<TTestDatabaseProvider>
    ...
    where TTestDatabaseProvider : ITestDatabaseProvider, new()
{
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_BuiltInType_CharTargetType_ColumnContainsStringWithLengthNotOne_ShouldThrow(
        bool useAsyncApi
    )
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_BuiltInType_CharTargetType_ColumnContainsStringWithLengthOne_ShouldGetFirstCharacter(
        bool useAsyncApi
    )
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_BuiltInType_EnumTargetType_ShouldConvertIntegerToEnum(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_BuiltInType_EnumTargetType_ShouldConvertStringToEnum(bool useAsyncApi)
    {
        var enumValue = Generate.Single<TestEnum>();
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_BuiltInType_ShouldSupportDateTimeOffsetValues(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_CommandType_ShouldUseCommandType(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_ComplexObjectsTemporaryTable_ShouldPassInterpolatedObjectsAsMultiColumnTemporaryTable(
        bool useAsyncApi
    )
    {
        Assert.SkipUnless(this.DatabaseAdapter.SupportsTemporaryTables(this.Connection), "");
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_EntityType_CharEntityProperty_ColumnContainsStringWithLengthNotOne_ShouldThrow(
        bool useAsyncApi
    )
    {
        if (this.TestDatabaseProvider is not OracleTestDatabaseProvider)
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_EntityType_CharEntityProperty_ColumnContainsStringWithLengthOne_ShouldGetFirstCharacter(
        bool useAsyncApi
    )
    {
        var character = Generate.Single<char>();
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_EntityType_ColumnHasNoName_ShouldThrow(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_EntityType_EntityTypeHasNoCorrespondingPropertyForColumn_ShouldIgnoreColumn(
        bool useAsyncApi
    )
    {
        var entity = (
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_EntityType_EntityTypeWithPropertiesWithDifferentCasing_ShouldMaterializeEntities(
        bool useAsyncApi
    )
    {
        var entity = this.CreateEntityInDb<Entity>();
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_EntityType_EnumEntityProperty_ColumnContainsInvalidInteger_ShouldThrow(
        bool useAsyncApi
    ) =>
        await Invoking(() =>
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_EntityType_EnumEntityProperty_ColumnContainsInvalidString_ShouldThrow(
        bool useAsyncApi
    ) =>
        await Invoking(() =>
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_EntityType_EnumEntityProperty_ShouldConvertIntegerToEnum(bool useAsyncApi)
    {
        var enumValue = Generate.Single<TestEnum>();
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_EntityType_EnumEntityProperty_ShouldConvertStringToEnum(bool useAsyncApi)
    {
        var enumValue = Generate.Single<TestEnum>();
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_EntityType_Mapping_Attributes_ShouldUseAttributesMapping(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_EntityType_Mapping_FluentApi_ShouldUseFluentApiMapping(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_EntityType_NoCompatibleConstructor_PrivateParameterlessConstructor_ShouldUsePrivateConstructorAndProperties(
        bool useAsyncApi
    )
    {
        var entity = this.CreateEntityInDb<Entity>();
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_EntityType_NoCompatibleConstructor_PublicParameterlessConstructor_ShouldUsePublicConstructorAndProperties(
        bool useAsyncApi
    )
    {
        var entity = this.CreateEntityInDb<Entity>();
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_EntityType_ShouldSupportDateTimeOffsetValues(bool useAsyncApi)
    {
        Assert.SkipUnless(this.TestDatabaseProvider.SupportsDateTimeOffset, "");
    ...
    [InlineData(false)]
    [InlineData(true)]
    public Task QuerySingleOrDefault_EntityType_UnsupportedFieldType_ShouldThrow(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_InterpolatedParameter_ShouldPassInterpolatedParameter(bool useAsyncApi)
    {
        var entity = this.CreateEntityInDb<Entity>();
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_Parameter_ShouldPassParameter(bool useAsyncApi)
    {
        var entity = this.CreateEntityInDb<Entity>();
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_QueryReturnedMoreThanOneRow_ShouldThrow(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_QueryReturnedNoRows_ShouldThrow(bool useAsyncApi)
    {
        (
            await CallApi<int>(
                useAsyncApi,
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_ScalarValuesTemporaryTable_ShouldPassInterpolatedValuesAsSingleColumnTemporaryTable(
        bool useAsyncApi
    )
    {
        Assert.SkipUnless(this.DatabaseAdapter.SupportsTemporaryTables(this.Connection), "");
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_Transaction_ShouldUseTransaction(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_ValueTupleType_CharValueTupleField_ColumnContainsStringWithLengthNotOne_ShouldThrow(
        bool useAsyncApi
    )
    {
        if (this.TestDatabaseProvider is not OracleTestDatabaseProvider)
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_ValueTupleType_CharValueTupleField_ColumnContainsStringWithLengthOne_ShouldGetFirstCharacter(
        bool useAsyncApi
    )
    {
        var character = Generate.Single<char>();
    ...
    [InlineData(false)]
    [InlineData(true)]
    public Task QuerySingleOrDefault_ValueTupleType_ColumnDataTypeNotCompatibleWithValueTupleFieldType_ShouldThrow(
        bool useAsyncApi
    ) =>
        Invoking(() =>
    ...
    [InlineData(false)]
    [InlineData(true)]
    public Task QuerySingleOrDefault_ValueTupleType_EnumValueTupleField_ColumnContainsInvalidInteger_ShouldThrow(
        bool useAsyncApi
    ) =>
        Invoking(() =>
    ...
    [InlineData(false)]
    [InlineData(true)]
    public Task QuerySingleOrDefault_ValueTupleType_EnumValueTupleField_ColumnContainsInvalidString_ShouldThrow(
        bool useAsyncApi
    ) =>
        Invoking(() =>
                CallApi<ValueTuple<TestEnum>>(
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_ValueTupleType_NullableValueTupleField_ColumnContainsNull_ShouldReturnNull(
        bool useAsyncApi
    )
    {
        await this.Connection.ExecuteNonQueryAsync(
    ...
    [InlineData(false)]
    [InlineData(true)]
    public Task QuerySingleOrDefault_ValueTupleType_NumberOfColumnsDoesNotMatchNumberOfValueTupleFields_ShouldThrow(
        bool useAsyncApi
    ) =>
        Invoking(() =>
                CallApi<(int, int)>(
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_ValueTupleType_ShouldMaterializeBinaryData(bool useAsyncApi)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task QuerySingleOrDefault_ValueTupleType_ShouldSupportDateTimeOffsetValues(bool useAsyncApi)
    {
        Assert.SkipUnless(this.TestDatabaseProvider.SupportsDateTimeOffset, "");
    ...
    [InlineData(false)]
    [InlineData(true)]
    public Task QuerySingleOrDefault_ValueTupleType_UnsupportedFieldType_ShouldThrow(bool useAsyncApi)
    {
        Assert.SkipUnless(this.TestDatabaseProvider.HasUnsupportedDataType, "");
