...
public class SqlServerTemporaryTableBuilderTests : UnitTestsBase
{
    private readonly SqlServerTemporaryTableBuilder builder = new(new());
    ...
    {
        ArgumentNullGuardVerifier.Verify(() => new SqlServerTemporaryTableBuilder(new()));
